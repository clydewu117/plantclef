...
CHECKPOINT_PATH = "checkpoints/dinov2_retrieval_best.pth"
RESULTS_DIR = "results"
...
def extract_features_limited(backbone, head, dataloader, device, max_samples=None):
    ...
    for imgs, labels in tqdm(dataloader, desc="Extracting features"):
        ...
        out = backbone.forward_features(imgs)
...
# Print results
print("\n" + "=" * 60)
print("DINOv2 ViT-B/14 Retrieval Test Results")
print("=" * 60)
...
result_file = os.path.join(RESULTS_DIR, "dinov2_retrieval_test.txt")

with open(result_file, "w") as f:
    f.write("DINOv2 ViT-B/14 Retrieval Test Results\n")
    f.write("=" * 60 + "\n")
